...
const openOrders = ['Side', 'Size', 'Price', 'Date Created', 'Status'];
    ...
    <>
      ...
      <div className="mb-12 grid grid-cols-1 gap-16 xl:grid-cols-3">
        ...
        <div className="flex flex-row items-center xl:col-span-2 ">
          ...
          >
            <span className="">Expert Mode</span>
            <Switch
      ...
      <div className="grid grid-cols-1 gap-16 xl:grid-cols-3 xl:place-items-center">
        ...
        <div className="xl:col-span-1">
          <TradeContainer>
            <div className=" border-b border-b-[#5841D8]/20 xs:mb-2 xs:mt-1">
              <div className="mb-4 border-b border-b-[#5841D8]/20 px-8">
                ...
                >
                  <li className="" role="presentation">
                    <a href="/swap">
                      <button
                        className="inline-block rounded-t-lg py-4 text-gray-300 focus:border-b-3 focus:border-b-[#FEB58D] dark:hover:text-[#FEB58D]200 dark:focus:text-white"
              ...
              <div className="my-4 flex flex-row justify-between gap-1 text-center">
                <div className="border rounded-[10px] px-2 dark:bg-[#1B0D6B] dark:border-[#5841D8]/50 flex flex-col items-start gap-4">
                  <span className="" style={{fontSize: '12px'}}>Order Price</span>
                  <div className="flex flex-row justify-between">
                    <input
                      type="text"
                      inputMode="decimal"
                      className={cn('w-[85px] h-[17px] px-4 mr-4 dark:bg-[#0D0C52] rounded-[10px] border-0 text-right outline-none dark:focus:ring-0')}
                    />
                    <div>USDC</div>
                  </div>
                </div>
                <div className="border rounded-[10px] px-2 dark:bg-[#1B0D6B] dark:border-[#5841D8]/50 flex flex-col items-end gap-4">
                  <span className="" style={{fontSize: '12px'}}>Expires in</span>
                  <SortList3 />
                </div>
              </div>
            </div>
        ...
        <div className="text-large rounded-[4px] text-center shadow-card outline outline-1 outline-offset-[16px] outline-[#0D0C52] xl:col-span-2 ">
          ...
          <div className="mt-4 min-h-[114px] w-[709px] rounded-[10px] px-8 pt-2 pb-6 dark:bg-[#0D0C52]">
            <div className="mx-4 gap-12 inline-flex justify-between rounded-md shadow-sm" role="group">
              <button
                type="button"
                className={cn(
                  'bg-transparent pt-4 pb-2 text-sm font-medium text-gray-900 hover:text-white focus:z-10  focus:text-white focus:ring-gray-500  dark:text-white dark:hover:text-[#FEB58D]',
            ...
            <div className="mt-2 bg-[#1B0D6B] px-4 rounded-[10px] border border-[#4910BA] h-[150px] overflow-y-auto p-4">
              <div className="border-b border-b-[#5841D8]/20">
                <div className="flex justify-between">
                  <span className="min-w-[110px] py-2 pr-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}>Symbol</span>
                  {openOrders.map((item, index) => 
                    <span key={index} className="p-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}>{item}</span>
                  )}
                  <span className="py-2 pl-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}></span>
                </div>
                <div className="flex justify-between">
                  <span className="min-w-[110px] py-2 pr-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}><CurrencySwapIcons2 from={tokenInIndex} to={tokenOutIndex} /></span>
                  {openOrders.map((item, index) => 
                    <span key={index} className="p-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}>{item}</span>
                  )}
                  <span className="py-2 pl-2 text-[#5841D8]" style={{fontFamily: 'Poppins', fontSize: '12px'}}></span>
